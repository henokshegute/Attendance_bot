...
function acceptLeave($id, $chat_id, $message_id)
{
    ...
    if ($lev_num > 0) {
        while ($ro = mysqli_fetch_array($query)) {
            ...
            $reason = $ro['reason'];
            $reqested_date=$ro['requested_date'];
        }
        $insertintoleavetable= "INSERT INTO leave_table (chat_id,name,number_of_days,starting_from,reason,requested_date) VALUES('$id','$name','$number_of_days','$starting_from','$reason','$reqested_date')";
        mysqli_query($con, $insertintoleavetable);
